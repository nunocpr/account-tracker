        ...
        if (!userId) {
            return NextResponse.json(
                { error: "Unauthorized" },
                {
                    status: 401,
                    statusText:
                        "You must be logged in to create a new sub category.",
                }
            );
        }
        ...
        if (type === ActionType.Add) {
            ...
            if (existingSubCategory) {
                return NextResponse.json(
                    ...
                    { status: 400, statusText: "Sub category already exists" }
                );
            }
            ...
            if (!existingSubCategory) {
                return NextResponse.json(
                    ...
                    { status: 404, statusText: "Sub category not found" }
                );
            }
            ...
            if (existingNewNameCategory) {
                return NextResponse.json(
                    ...
                    { status: 400, statusText: "Category' name already exists" }
                );
            }
            ...
            if (!updatedSubCategory) {
                return NextResponse.json(
                    ...
                    {
                        status: 500,
                        statusText: "An error occurred when updating category",
                    }
                );
            }
            ...
            return NextResponse.json(
                ...
                {
                    status: 200,
                    statusText: `The category has been updated to ${newSubCategory}`,
                }
            );
            ...
            if (!deletedSubCategory) {
                return NextResponse.json(
                    ...
                    {
                        status: 500,
                        statusText: "An error occurred when deleting category",
                    }
                );
            }
            ...
            return NextResponse.json(
                ...
                {
                    status: 200,
                    statusText: `The category ${subCategory} has been deleted`,
                }
            );
        } else {
